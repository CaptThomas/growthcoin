...
"""Growthcoin P2P network half-a-node.
...
MAGIC_BYTES = {
    "mainnet": b"\x47\x52\x4f\x57",   # mainnet
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        logger.debug('Connecting to Growthcoin Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Growthcoin node.
