...
"""Verify that starting growthcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start growthcoin with -h for help text")
        ...
        self.log.info("Start growthcoin with -version for version information")
        ...
        self.log.info("Start growthcoind with -fakearg to make sure it does not start")
