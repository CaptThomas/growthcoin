...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " growthcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  growthcoin-tx [options] <hex-tx> [commands]  Update hex-encoded growthcoin transaction\n" +
            "or:     growthcoin-tx [options] -create [commands]   Create hex-encoded growthcoin transaction\n" +
            "\n";
