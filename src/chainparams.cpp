...
{
    const char* pszTimestamp = "POLITICO NEWS 11/Aug/2021 Biden on Afghanistan: Not my problem";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 672;
        ...
        consensus.nPowTargetTimespan = 21 * 24 * 60 * 60; // 3 weeks
        ...
        consensus.defaultAssumeValid = uint256S("0xecd958958afcd96f68729946969bea0c78c6306bdbaace30d11a9d58dc0d9f45"); //43
        ...
        genesis = CreateGenesisBlock(1628739497, 2089031935, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc686bd0a14944586941c4662d91b94ba07f48727a17c0088b30625c8d4da05e2"));
        assert(genesis.hashMerkleRoot == uint256S("0xaa06330077198b5f5dad057fb6ed5be424de4a0ba8c425c3a22dfcfd281c1547"));
        ...
        // vSeeds.emplace_back("seed-a.growthcoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.growthcointools.com");
        // vSeeds.emplace_back("dnsseed.growthcoinpool.org");
	   vSeeds.emplace_back("dnsseed.growthcoin.tk");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x47, 0x52, 0x4F, 0x57};
        base58Prefixes[EXT_SECRET_KEY] = {0x47, 0x53, 0x45, 0x43};
        ...
        checkpointData = {
            {
                {  0, uint256S("0xc686bd0a14944586941c4662d91b94ba07f48727a17c0088b30625c8d4da05e2")},
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.growthcointools.com");
        vSeeds.emplace_back("seed-b.growthcoin.loshan.co.uk");
