# Support for Output Descriptors in Growthcoin Core

Since Growthcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Growthcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Growthcoin Core wallets, a convenience function `combo` is
